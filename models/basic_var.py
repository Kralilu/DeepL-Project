...
class SelfAttention(nn.Module):
    def __init__(
        self, block_idx, embed_dim=None, num_heads=None, attn_drop=0., proj_drop=0., attn_l2_norm=False, flash_if_available=False
    ):
        super().__init__()
        embed_dim = 256
        num_heads = 4
...
class AdaLNSelfAttn(nn.Module):
    def __init__(
        ...
        num_heads, mlp_ratio=2., drop=0., attn_drop=0., drop_path=0., attn_l2_norm=False,
