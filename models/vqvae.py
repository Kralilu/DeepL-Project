...
class VQVAE(nn.Module):
    def __init__(
        self, vocab_size=512, z_channels=32, ch=64, dropout=0.1,
        ...
        v_patch_nums=(1, 2, 3, 4, 5, 6, 8), # number of patches for each scale, h_{1 to K} = w_{1 to K} = v_patch_nums[k]
        test_mode=True,
    ):
        super().__init__()
        ...
        ddconfig = dict(
            ...
            in_channels=3, ch_mult=(1, 1, 2, 2), num_res_blocks=2,   # from vq-f16/config.yaml above
