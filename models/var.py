...
class VAR(nn.Module):
    def __init__(
        ...
        num_classes=200, depth=8, embed_dim=256, num_heads=4, mlp_ratio=2., drop_rate=0.05, attn_drop_rate=0.05, drop_path_rate=0.05,
        norm_eps=1e-6, shared_aln=False, cond_drop_rate=0.1,
        attn_l2_norm=False,
        patch_nums=(1, 2, 3, 4, 5, 6, 8),   # 10 steps by default
