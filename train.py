...
from utils.data_sampler import InfiniteBatchSampler
from utils.misc import auto_resume

import importlib
importlib.reload(arg_util)
...
def build_everything(args: arg_util.Args):
    ...
    if with_tb_lg:
        ...
        # noinspection PyTypeChecker
        tb_lg = misc.TensorboardLogger(log_dir=args.tb_log_dir_path, filename_suffix=f'__{misc.time_str("%m%d_%H%M")}')
    # log args
    ...
    if not args.local_debug:
        ...
        ld_train = DataLoader(
            dataset=dataset_train, batch_size=args.batch_size, shuffle=True, num_workers=args.workers, pin_memory=True,
    ...
    vae_local, var_wo_ddp = build_vae_var(
        ...
        device='cuda', patch_nums=args.patch_nums,
